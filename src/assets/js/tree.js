  ...
  var tree = {
        ...
        if (p_parentNode == undefined) {
          ...
          if (p_parentNode.childNodes.length == 0) {
            if (p_parentNode.expanded) {
              ...
              v_img.src = './assets/svg/collapse.svg';
              v_img.id = 'toggle_off';
            }
            else {
              ...
              v_img = p_parentNode.elementLi.getElementsByTagName("img")[0];
              v_img.style.visibility = "visible";
              v_img.src = './assets/svg/expand.svg';
              v_img.id = 'toggle_on';
            }
          }
    ...
    drawNode: function (p_ulElement, p_node) {
      ...
      if (p_node.childNodes.length == 0) {
        v_exp_col = createImgElement('toggle_off', 'exp_col', './assets/svg/collapse.svg');
        ...
        if (p_node.expanded) {
          ...
          v_exp_col = createImgElement('toggle_on', 'exp_col', './assets/svg/expand.svg');
        }
      }
